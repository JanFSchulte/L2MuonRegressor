...
input_branches = [
    'seg1_x','seg1_y', 'seg1_z', 'seg1_r', 'seg1_lay',
    'seg2_x','seg2_y', 'seg2_z', 'seg2_r', 'seg2_lay',
    'seg3_x','seg3_y', 'seg3_z', 'seg3_r', 'seg3_lay',
    'seg4_x','seg4_y', 'seg4_z', 'seg4_r', 'seg4_lay',
    "phiBend12", "phiBend23", "phiBend34"
]

df = pd.read_csv("inputfile_regressorTraining.csv")
truth_columns = ['L2_pt']

prediction_columns = ['pred L2_pt']
save = True
